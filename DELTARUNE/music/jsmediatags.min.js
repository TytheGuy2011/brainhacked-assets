            ...
            h = function() {
                ...
                q(h, [{
                    ...
                    value: function(f, c) {
                        ...
                        if (-1 === g.startIx) this._fileData.splice(g.insertIx || 0, 0, {
                            offset: f,
                            data: c
                        });
                        else {
                    ...
                    value: function(f, c) {
                        ...
                        for (e = k; e < this._fileData.length && !(g = this._fileData[e].offset, b = g + this._fileData[e].data.length, c >= g - 1 && (r = e), c <= b + 1); e++); - 1 === r && (r = k);
                        return {
                            startIx: k,
                            endIx: r
                        }
                    ...
                    value: function(e, d, b, c, g) {
                        for (var l = {}, k = this._getFrameHeaderSize(c); e < d - k;) {
                            ...
                            if (!g || -1 !== g.indexOf(u)) {
                                ...
                                h && h.format.unsynchronisation && !c.flags.unsynchronisation && (m = this.getUnsyncFileReader(m, r, w), r = 0, w = m.getSize());
        ...
        14: [function(h, p, n) {
            ...
            n = function(a) {
                ...
                t(e, [{
                    ...
                    value: function(a, b) {
                        var d = this;
                        d._fileData.hasDataRange(a[0], Math.min(d._size, a[1])) ? setTimeout(b.onSuccess, 1) : (a = this._roundRangeToChunkMultiple(a), a[1] = Math.min(d._size, a[1]), this._makeXHRRequest("GET", a, {
